...
class CartController extends Controller
{
    ...
    {
        $data['adress'] = User::where('id',Auth::id())->get();
        $data['total'] = AddToCart::where('user_id',Auth::id())->select("*", DB::raw('SUM(price) as total'))->groupBy('user_id')->get();
        $data['cart'] = AddToCart::where('user_id',Auth::id())->select("*", DB::raw('SUM(qty) as tqty'))->groupBy('product_id')->get();
